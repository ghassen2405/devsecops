...
public class LoginController implements Initializable {
    ...
    private void showProfile(ActionEvent event) throws IOException {
        ...
        if (UserConnected == null) {
            showAlert(Alert.AlertType.ERROR, "No user logged in!", "You must be logged in to view the profile.");
        ...
        try {
            ...
            // Pass the logged-in user to the profile controller
            profileController.setUser(UserConnected); // Pass the logged-in user object
